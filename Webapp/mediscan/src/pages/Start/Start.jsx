    ...
    <div className="app-container">
      ...
      <section className="hero-section">
        <div className="hero-text">
          ...
          <p>
            MediCan provides affordable healthcare, accessible on mobile and
            online for everyone.
          </p>
          <Link to="/login" className="action-button">
            Continue as User
          </Link>
          <Link to="/home" className="action-button guest-button">
            Continue as Guest
          </Link>
        </div>
      ...
      <section className="why-choose-us" id="why-choose-us">
        <h2>Why Choose Us</h2>
        <p>
          Our advanced diagnostic technology ensures accurate, timely results.
        </p>
        <div className="video-container">
          <video controls src="https://www.example.com/intro-video.mp4">
            {" "}
